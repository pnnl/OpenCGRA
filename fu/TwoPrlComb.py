...
class TwoPrlComb( Component ):
  ...
  def line_trace( s ):
    return f'[{s.recv_in0.msg}] {OPT_SYMBOL_DICT[s.recv_opt0.msg]} [{s.recv_in1.msg}] = [{s.send_out1.msg}]; [{s.recv_in2.msg}] {OPT_SYMBOL_DICT[s.recv_opt1.msg]} [{s.recv_in3.msg}] = [{s.send_out1.msg}]'
