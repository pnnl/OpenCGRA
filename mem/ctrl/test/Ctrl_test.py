...
class TestHarness( Component ):
  ...
  def construct( s, DataType, ConfigType, ctrl_mem_size, data_mem_size,
    ...
    s.ctrl_mem  = CtrlMem( ConfigType, ctrl_mem_size )
...
def test_Ctrl():
  ...
  th = TestHarness( DataType, CtrlType, ctrl_mem_size, data_mem_size,
