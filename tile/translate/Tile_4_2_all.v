...
module FlexibleFu__a873a61f52ee90ac
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  ...
  logic [0:0] fu__recv_in__en [0:7][0:3] ;
  CGRAData_32_1 fu__recv_in__msg [0:7][0:3] ;
  logic [0:0] fu__recv_in__rdy [0:7][0:3] ;
  logic [0:0] fu__recv_opt__en [0:7] ;
  CGRAConfig_5_6_8 fu__recv_opt__msg [0:7] ;
...
(
  ...
  FlexibleFu__a873a61f52ee90ac element
  (
    .clk( element__clk ),
