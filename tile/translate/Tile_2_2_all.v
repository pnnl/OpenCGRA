...
// PyMTL BitStruct CGRAConfig_5_6_6 Definition
// At BitStruct CGRAConfig_5_6_6
typedef struct packed {
  logic [4:0] ctrl ;
  logic [5:0][2:0] outport ;
} CGRAConfig_5_6_6;
...
// Full name: Crossbar__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_6__num_inports_6__num_outports_6
...
// PyMTL Component RegisterFile Definition
// Full name: RegisterFile__Type_CGRAConfig_5_6_6__nregs_3__rd_ports_1__wr_ports_1__const_zero_False
// At /home/ct535/project/venv_latest_pymtl3/src/pymtl3/pymtl3/stdlib/rtl/RegisterFile.py

module RegisterFile__c03acdb717cf6fb7
(
  input logic [0:0] clk,
  input logic [1:0] raddr [0:0],
  output CGRAConfig_5_6_6 rdata [0:0],
  input logic [0:0] reset,
  input logic [1:0] waddr [0:0],
  input CGRAConfig_5_6_6 wdata [0:0],
  input logic [0:0] wen [0:0]
);
  localparam logic [31:0] __const__rd_ports_at_up_rf_read = 32'd1;
  localparam logic [31:0] __const__wr_ports_at_up_rf_write = 32'd1;
  CGRAConfig_5_6_6 regs [0:2] ;
...
// Full name: Alu__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Alu.py

module Alu__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
...
// Full name: Mul__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Mul.py

module Mul__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: Logic__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Logic.py

module Logic__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: Shifter__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Shifter.py

module Shifter__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: Phi__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Phi.py

module Phi__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: Comp__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Comp.py

module Comp__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: Branch__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Branch.py

module Branch__34a50faaa9280c3b
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: MemUnit__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/MemUnit.py

module MemUnit__c9c2b65b4e6eebc2
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// Full name: FlexibleFu__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_6__num_inports_2__num_outports_2__data_mem_size_8__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>, <class 'PyCGRA.fu.single.Mul.Mul'>, <class 'PyCGRA.fu.single.Logic.Logic'>, <class 'PyCGRA.fu.single.Shifter.Shifter'>, <class 'PyCGRA.fu.single.Phi.Phi'>, <class 'PyCGRA.fu.single.Comp.Comp'>, <class 'PyCGRA.fu.single.Branch.Branch'>, <class 'PyCGRA.fu.single.MemUnit.MemUnit'>]
// At /home/ct535/project/PyCGRA/fu/flexible/FlexibleFu.py

module FlexibleFu__6facd5c1a8db4414
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en [0:7],
  input CGRAData_32_1 from_mem_rdata__msg [0:7],
  ...
  output CGRAData_32_1 send_out__msg [0:1],
  input logic [0:0] send_out__rdy [0:1],
  output logic [0:0] to_mem_raddr__en [0:7],
  output logic [2:0] to_mem_raddr__msg [0:7],
  input logic [0:0] to_mem_raddr__rdy [0:7],
  output logic [0:0] to_mem_waddr__en [0:7],
  output logic [2:0] to_mem_waddr__msg [0:7],
  input logic [0:0] to_mem_waddr__rdy [0:7],
  output logic [0:0] to_mem_wdata__en [0:7],
  output CGRAData_32_1 to_mem_wdata__msg [0:7],
  input logic [0:0] to_mem_wdata__rdy [0:7]
);
  localparam logic [31:0] fu_list_size = 32'd8;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [31:0] __const__num_inports_at_comb_logic = 32'd2;
  //-------------------------------------------------------------
  // Component fu[0:7]
  ...
  logic [0:0] fu__from_mem_rdata__en [0:7] ;
  CGRAData_32_1 fu__from_mem_rdata__msg [0:7] ;
  logic [0:0] fu__from_mem_rdata__rdy [0:7] ;
  logic [0:0] fu__recv_const__en [0:7] ;
  CGRAData_32_1 fu__recv_const__msg [0:7] ;
  logic [0:0] fu__recv_const__rdy [0:7] ;
  logic [0:0] fu__recv_in__en [0:7][0:1] ;
  CGRAData_32_1 fu__recv_in__msg [0:7][0:1] ;
  logic [0:0] fu__recv_in__rdy [0:7][0:1] ;
  logic [0:0] fu__recv_opt__en [0:7] ;
  CGRAConfig_5_6_6 fu__recv_opt__msg [0:7] ;
  logic [0:0] fu__recv_opt__rdy [0:7] ;
  logic [0:0] fu__send_out__en [0:7][0:1] ;
  CGRAData_32_1 fu__send_out__msg [0:7][0:1] ;
  logic [0:0] fu__send_out__rdy [0:7][0:1] ;
  logic [0:0] fu__to_mem_raddr__en [0:7] ;
  logic [2:0] fu__to_mem_raddr__msg [0:7] ;
  logic [0:0] fu__to_mem_raddr__rdy [0:7] ;
  logic [0:0] fu__to_mem_waddr__en [0:7] ;
  logic [2:0] fu__to_mem_waddr__msg [0:7] ;
  logic [0:0] fu__to_mem_waddr__rdy [0:7] ;
  logic [0:0] fu__to_mem_wdata__en [0:7] ;
  CGRAData_32_1 fu__to_mem_wdata__msg [0:7] ;
  logic [0:0] fu__to_mem_wdata__rdy [0:7] ;

  Alu__34a50faaa9280c3b fu__0
  (
    .clk( fu__clk[0] ),
    .reset( fu__reset[0] ),
  ...
  Shifter__34a50faaa9280c3b fu__3
  (
    .clk( fu__clk[3] ),
    .reset( fu__reset[3] ),
  ...
  Branch__34a50faaa9280c3b fu__6
  (
    .clk( fu__clk[6] ),
    .reset( fu__reset[6] ),
  ...
  MemUnit__c9c2b65b4e6eebc2 fu__7
  (
    .clk( fu__clk[7] ),
    .reset( fu__reset[7] ),
...
// Full name: Tile__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_6__ctrl_mem_size_3__data_mem_size_8__num_ctrl_3__num_fu_inports_2__num_fu_outports_2__num_connect_inports_4__num_connect_outports_4__Fu_FlexibleFu__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>, <class 'PyCGRA.fu.single.Mul.Mul'>, <class 'PyCGRA.fu.single.Logic.Logic'>, <class 'PyCGRA.fu.single.Shifter.Shifter'>, <class 'PyCGRA.fu.single.Phi.Phi'>, <class 'PyCGRA.fu.single.Comp.Comp'>, <class 'PyCGRA.fu.single.Branch.Branch'>, <class 'PyCGRA.fu.single.MemUnit.MemUnit'>]
// At /home/ct535/project/PyCGRA/tile/Tile.py

module Tile__dd9bb0c19d8adc84
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  input CGRAConfig_5_6_6 recv_wopt__msg,
  ...
  //-------------------------------------------------------------
  // Component channel[0:5]
  //-------------------------------------------------------------

  logic [0:0] channel__clk [0:5] ;
  logic [0:0] channel__reset [0:5] ;
  logic [0:0] channel__recv__en [0:5] ;
  CGRAData_32_1 channel__recv__msg [0:5] ;
  logic [0:0] channel__recv__rdy [0:5] ;
  logic [0:0] channel__send__en [0:5] ;
  CGRAData_32_1 channel__send__msg [0:5] ;
  logic [0:0] channel__send__rdy [0:5] ;
  ...
  CGRAConfig_5_6_6 crossbar__recv_opt__msg ;
  logic [0:0] crossbar__recv_opt__rdy ;
  logic [0:0] crossbar__send_data__en [0:5] ;
  CGRAData_32_1 crossbar__send_data__msg [0:5] ;
  logic [0:0] crossbar__send_data__rdy [0:5] ;

  Crossbar__85a8b278d9b91463 crossbar
  (
    .clk( crossbar__clk ),
  ...
  CGRAConfig_5_6_6 ctrl_mem__recv_ctrl__msg ;
  ...
  CGRAConfig_5_6_6 ctrl_mem__send_ctrl__msg ;
  logic [0:0] ctrl_mem__send_ctrl__rdy ;

  CtrlMem__CtrlType_CGRAConfig_5_6_6__ctrl_mem_size_3__num_ctrl_3 ctrl_mem
  (
    .clk( ctrl_mem__clk ),
  ...
  logic [0:0] element__from_mem_rdata__en [0:7] ;
  CGRAData_32_1 element__from_mem_rdata__msg [0:7] ;
  ...
  logic [0:0] element__recv_in__en [0:1] ;
  CGRAData_32_1 element__recv_in__msg [0:1] ;
  logic [0:0] element__recv_in__rdy [0:1] ;
  logic [0:0] element__recv_opt__en ;
  CGRAConfig_5_6_6 element__recv_opt__msg ;
  ...
  logic [0:0] element__to_mem_raddr__en [0:7] ;
  logic [2:0] element__to_mem_raddr__msg [0:7] ;
  logic [0:0] element__to_mem_raddr__rdy [0:7] ;
  logic [0:0] element__to_mem_waddr__en [0:7] ;
  logic [2:0] element__to_mem_waddr__msg [0:7] ;
  logic [0:0] element__to_mem_waddr__rdy [0:7] ;
  logic [0:0] element__to_mem_wdata__en [0:7] ;
  CGRAData_32_1 element__to_mem_wdata__msg [0:7] ;
  logic [0:0] element__to_mem_wdata__rdy [0:7] ;

  FlexibleFu__6facd5c1a8db4414 element
  (
    .clk( element__clk ),
