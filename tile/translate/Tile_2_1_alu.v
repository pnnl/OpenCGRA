...
// PyMTL BitStruct CGRAConfig_5_5_6 Definition
// At BitStruct CGRAConfig_5_5_6
typedef struct packed {
  logic [4:0] ctrl ;
...
// Full name: Crossbar__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_5_6__num_inports_5__num_outports_6
...
// PyMTL Component RegisterFile Definition
// Full name: RegisterFile__Type_CGRAConfig_5_5_6__nregs_3__rd_ports_1__wr_ports_1__const_zero_False
// At /home/ct535/project/venv_latest_pymtl3/src/pymtl3/pymtl3/stdlib/rtl/RegisterFile.py

module RegisterFile__b7926dbb0b6f094e
(
  input logic [0:0] clk,
  input logic [1:0] raddr [0:0],
  output CGRAConfig_5_5_6 rdata [0:0],
  input logic [0:0] reset,
  input logic [1:0] waddr [0:0],
  input CGRAConfig_5_5_6 wdata [0:0],
  input logic [0:0] wen [0:0]
);
  localparam logic [31:0] __const__rd_ports_at_up_rf_read = 32'd1;
  localparam logic [31:0] __const__wr_ports_at_up_rf_write = 32'd1;
  CGRAConfig_5_5_6 regs [0:2] ;
...
// Full name: Alu__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_5_6__num_inports_2__num_outports_1__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Alu.py

module Alu__6b5c1e50bbd176a5
(
  input logic [0:0] clk,
  input logic [0:0] reset,
...
// Full name: FlexibleFu__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_5_6__num_inports_2__num_outports_1__data_mem_size_8__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>]
// At /home/ct535/project/PyCGRA/fu/flexible/FlexibleFu.py

module FlexibleFu__68acc50e28a4fbf7
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  ...
  logic [0:0] fu__recv_in__en [0:0][0:1] ;
  CGRAData_32_1 fu__recv_in__msg [0:0][0:1] ;
  logic [0:0] fu__recv_in__rdy [0:0][0:1] ;
  logic [0:0] fu__recv_opt__en [0:0] ;
  CGRAConfig_5_5_6 fu__recv_opt__msg [0:0] ;
  logic [0:0] fu__recv_opt__rdy [0:0] ;
  logic [0:0] fu__send_out__en [0:0][0:0] ;
  CGRAData_32_1 fu__send_out__msg [0:0][0:0] ;
  logic [0:0] fu__send_out__rdy [0:0][0:0] ;
...
// Full name: Tile__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_5_6__ctrl_mem_size_3__data_mem_size_8__num_ctrl_3__num_fu_inports_2__num_fu_outports_1__num_connect_inports_4__num_connect_outports_4__Fu_FlexibleFu__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>]
// At /home/ct535/project/PyCGRA/tile/Tile.py

module Tile__3208b7b97cebae7e
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  input CGRAConfig_5_5_6 recv_wopt__msg,
  ...
  logic [0:0] crossbar__recv_data__en [0:4] ;
  CGRAData_32_1 crossbar__recv_data__msg [0:4] ;
  logic [0:0] crossbar__recv_data__rdy [0:4] ;
  logic [0:0] crossbar__recv_opt__en ;
  CGRAConfig_5_5_6 crossbar__recv_opt__msg ;
  ...
  Crossbar__98fa4340c7cb5a19 crossbar
  (
    .clk( crossbar__clk ),
  ...
  CGRAConfig_5_5_6 ctrl_mem__recv_ctrl__msg ;
  ...
  CGRAConfig_5_5_6 ctrl_mem__send_ctrl__msg ;
  logic [0:0] ctrl_mem__send_ctrl__rdy ;

  CtrlMem__CtrlType_CGRAConfig_5_5_6__ctrl_mem_size_3__num_ctrl_3 ctrl_mem
  (
    .clk( ctrl_mem__clk ),
  ...
  CGRAConfig_5_5_6 element__recv_opt__msg ;
  logic [0:0] element__recv_opt__rdy ;
  logic [0:0] element__send_out__en [0:0] ;
  CGRAData_32_1 element__send_out__msg [0:0] ;
  logic [0:0] element__send_out__rdy [0:0] ;
  ...
  FlexibleFu__68acc50e28a4fbf7 element
  (
    .clk( element__clk ),
