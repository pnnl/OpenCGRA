...
// Full name: Mul__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Mul.py

module Mul__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_MUL = 5'd7;
  localparam logic [4:0] __const__OPT_DIV = 5'd26;
...
// PyMTL Component Logic Definition
// Full name: Logic__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Logic.py

module Logic__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_OR = 5'd8;
  localparam logic [4:0] __const__OPT_AND = 5'd10;
  localparam logic [4:0] __const__OPT_NOT = 5'd11;
  localparam logic [4:0] __const__OPT_XOR = 5'd9;
  ...
  always_comb begin : comb_logic
    ...
    if ( recv_opt__msg.ctrl == __const__OPT_OR ) begin
      ...
      send_out__msg[0].payload = ~recv_in__msg[0].payload;
    end
...
// PyMTL Component Shifter Definition
// Full name: Shifter__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Shifter.py

module Shifter__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_LLS = 5'd5;
  localparam logic [4:0] __const__OPT_LRS = 5'd6;
...
// PyMTL Component Phi Definition
// Full name: Phi__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Phi.py

module Phi__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_PHI = 5'd17;
  ...
  always_comb begin : comb_logic
    ...
    if ( recv_opt__msg.ctrl == __const__OPT_PHI ) begin
      if ( recv_in__msg[0].predicate == 1'd1 ) begin
        send_out__msg[0] = recv_in__msg[0];
      end
      else if ( recv_in__msg[1].predicate == 1'd1 ) begin
        send_out__msg[0] = recv_in__msg[1];
      end
      else begin
        send_out__msg[0] = recv_in__msg[0];
...
// PyMTL Component Comp Definition
// Full name: Comp__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Comp.py

module Comp__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam CGRAData_32_1 const_one = { 32'd1, 1'd0 };
  localparam CGRAData_32_1 const_zero = { 32'd0, 1'd0 };
  localparam logic [31:0] __const__num_inports_at_update_signal = 32'd4;
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_EQ = 5'd14;
  localparam logic [4:0] __const__OPT_LE = 5'd15;
  logic [0:0] __tmpvar__comb_logic_predicate ;
  ...
  always_comb begin : comb_logic
    __tmpvar__comb_logic_predicate = recv_in__msg[0].predicate & recv_in__msg[1].predicate;
    send_out__msg[0] = const_one;
    for ( int j = 0; j < __const__num_outports_at_comb_logic; j += 1 )
      send_out__en[j] = recv_opt__en;
    if ( recv_opt__msg.ctrl == __const__OPT_EQ ) begin
      if ( recv_in__msg[0].payload == recv_in__msg[1].payload ) begin
        send_out__msg[0] = const_one;
        send_out__msg[0].predicate = __tmpvar__comb_logic_predicate;
      end
      else begin
...
// PyMTL Component Branch Definition
// Full name: Branch__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Branch.py

module Branch__69fcd339a65ec916
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_update_signal = 32'd2;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_BRH = 5'd16;
  ...
  always_comb begin : comb_logic
    ...
    if ( recv_opt__msg.ctrl == __const__OPT_BRH ) begin
      send_out__msg[0].payload = recv_in__msg[0].payload;
      send_out__msg[1].payload = recv_in__msg[0].payload;
      if ( recv_in__msg[1].payload == 32'd0 ) begin
        send_out__msg[0].predicate = 1'd1;
...
// PyMTL Component MemUnit Definition
// Full name: MemUnit__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/MemUnit.py

module MemUnit__d7737d485a172c54
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [4:0] __const__OPT_LD = 5'd12;
  localparam logic [4:0] __const__OPT_STR = 5'd13;
  ...
  always_comb begin : comb_logic
    for ( int i = 2; i < __const__num_inports_at_comb_logic; i += 1 )
      for ( int j = 0; j < __const__num_outports_at_comb_logic; j += 1 )
        recv_in__rdy[i] = send_out__rdy[j] || recv_in__rdy[i];
    for ( int j = 0; j < __const__num_outports_at_comb_logic; j += 1 )
      recv_const__rdy = send_out__rdy[j] || recv_const__rdy;
    ...
    if ( recv_opt__msg.ctrl == __const__OPT_LD ) begin
      send_out__en[0] = from_mem_rdata__en && recv_in__en[0];
      recv_in__rdy[0] = to_mem_raddr__rdy;
      recv_in__rdy[1] = from_mem_rdata__rdy;
      to_mem_raddr__msg = 3'( recv_in__msg[0].payload );
      to_mem_raddr__en = recv_in__en[0];
      from_mem_rdata__rdy = send_out__rdy[0];
      send_out__msg[0] = from_mem_rdata__msg;
    end
    else if ( recv_opt__msg.ctrl == __const__OPT_STR ) begin
      send_out__en[0] = from_mem_rdata__en && recv_in__en[0] && recv_in__en[1];
      recv_in__rdy[0] = to_mem_waddr__rdy;
      recv_in__rdy[1] = to_mem_wdata__rdy;
      to_mem_waddr__msg = 3'( recv_in__msg[0].payload );
      to_mem_waddr__en = recv_in__en[0];
      to_mem_wdata__msg = recv_in__msg[1];
      to_mem_wdata__en = recv_in__en[1];
      send_out__en[0] = 1'd0;
      send_out__msg[0] = from_mem_rdata__msg;
    end
    else
...
// PyMTL Component Mul Definition
// Full name: Mul__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_2__num_outports_1__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Mul.py

module Mul__e40fd35acc74a5b8
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  input CGRAData_32_1 recv_in__msg [0:1],
  output logic [0:0] recv_in__rdy [0:1],
  input logic [0:0] recv_opt__en,
  input CGRAConfig_5_6_8 recv_opt__msg,
  output logic [0:0] recv_opt__rdy,
  output logic [0:0] send_out__en [0:0],
  output CGRAData_32_1 send_out__msg [0:0],
  ...
  localparam CGRAData_32_1 const_zero = { 32'd0, 1'd0 };
  localparam logic [31:0] __const__num_inports_at_update_signal = 32'd2;
...
// PyMTL Component Alu Definition
// Full name: Alu__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_2__num_outports_1__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Alu.py

module Alu__e40fd35acc74a5b8
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// PyMTL Component Shifter Definition
// Full name: Shifter__DataType_CGRAData_32_1__ConfigType_CGRAConfig_5_6_8__num_inports_2__num_outports_1__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/single/Shifter.py

module Shifter__e40fd35acc74a5b8
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
...
// PyMTL Component ThreeMulAluShifter Definition
// Full name: ThreeMulAluShifter__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8
// At /home/ct535/project/PyCGRA/fu/triple/ThreeMulAluShifter.py

module ThreeMulAluShifter__d7737d485a172c54
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  localparam CGRAData_32_1 const_zero = { 32'd0, 1'd0 };
  localparam logic [4:0] __const__OPT_MUL_ADD_LLS = 5'd22;
  localparam logic [4:0] __const__OPT_MUL = 5'd7;
  localparam logic [4:0] __const__OPT_ADD = 5'd2;
  localparam logic [4:0] __const__OPT_LLS = 5'd5;
  localparam logic [4:0] __const__OPT_MUL_SUB_LLS = 5'd23;
  localparam logic [4:0] __const__OPT_SUB = 5'd4;
  localparam logic [4:0] __const__OPT_MUL_SUB_LRS = 5'd24;
  localparam logic [4:0] __const__OPT_LRS = 5'd6;
  localparam logic [31:0] __const__num_outports_at_update_opt = 32'd2;
  //-------------------------------------------------------------
  // Component Fu0
  //-------------------------------------------------------------
  ...
  CGRAData_32_1 Fu0__from_mem_rdata__msg ;
  logic [0:0] Fu0__from_mem_rdata__rdy ;
  logic [0:0] Fu0__recv_const__en ;
  CGRAData_32_1 Fu0__recv_const__msg ;
  logic [0:0] Fu0__recv_const__rdy ;
  logic [0:0] Fu0__recv_in__en [0:1] ;
  CGRAData_32_1 Fu0__recv_in__msg [0:1] ;
  logic [0:0] Fu0__recv_in__rdy [0:1] ;
  logic [0:0] Fu0__recv_opt__en ;
  CGRAConfig_5_6_8 Fu0__recv_opt__msg ;
  logic [0:0] Fu0__recv_opt__rdy ;
  logic [0:0] Fu0__send_out__en [0:0] ;
  CGRAData_32_1 Fu0__send_out__msg [0:0] ;
  logic [0:0] Fu0__send_out__rdy [0:0] ;
  logic [0:0] Fu0__to_mem_raddr__en ;
  logic [2:0] Fu0__to_mem_raddr__msg ;
  logic [0:0] Fu0__to_mem_raddr__rdy ;
  logic [0:0] Fu0__to_mem_waddr__en ;
  logic [2:0] Fu0__to_mem_waddr__msg ;
  logic [0:0] Fu0__to_mem_waddr__rdy ;
  logic [0:0] Fu0__to_mem_wdata__en ;
  CGRAData_32_1 Fu0__to_mem_wdata__msg ;
  logic [0:0] Fu0__to_mem_wdata__rdy ;

  Mul__e40fd35acc74a5b8 Fu0
  (
    .clk( Fu0__clk ),
    .reset( Fu0__reset ),
  ...
  CGRAData_32_1 Fu1__from_mem_rdata__msg ;
  logic [0:0] Fu1__from_mem_rdata__rdy ;
  logic [0:0] Fu1__recv_const__en ;
  CGRAData_32_1 Fu1__recv_const__msg ;
  logic [0:0] Fu1__recv_const__rdy ;
  logic [0:0] Fu1__recv_in__en [0:1] ;
  CGRAData_32_1 Fu1__recv_in__msg [0:1] ;
  logic [0:0] Fu1__recv_in__rdy [0:1] ;
  logic [0:0] Fu1__recv_opt__en ;
  CGRAConfig_5_6_8 Fu1__recv_opt__msg ;
  logic [0:0] Fu1__recv_opt__rdy ;
  logic [0:0] Fu1__send_out__en [0:0] ;
  CGRAData_32_1 Fu1__send_out__msg [0:0] ;
  logic [0:0] Fu1__send_out__rdy [0:0] ;
  logic [0:0] Fu1__to_mem_raddr__en ;
  logic [2:0] Fu1__to_mem_raddr__msg ;
  logic [0:0] Fu1__to_mem_raddr__rdy ;
  logic [0:0] Fu1__to_mem_waddr__en ;
  logic [2:0] Fu1__to_mem_waddr__msg ;
  logic [0:0] Fu1__to_mem_waddr__rdy ;
  logic [0:0] Fu1__to_mem_wdata__en ;
  CGRAData_32_1 Fu1__to_mem_wdata__msg ;
  logic [0:0] Fu1__to_mem_wdata__rdy ;

  Alu__e40fd35acc74a5b8 Fu1
  (
    .clk( Fu1__clk ),
    .reset( Fu1__reset ),
  ...
  logic [0:0] Fu2__from_mem_rdata__en ;
  CGRAData_32_1 Fu2__from_mem_rdata__msg ;
  logic [0:0] Fu2__from_mem_rdata__rdy ;
  logic [0:0] Fu2__recv_const__en ;
  CGRAData_32_1 Fu2__recv_const__msg ;
  logic [0:0] Fu2__recv_const__rdy ;
  logic [0:0] Fu2__recv_in__en [0:1] ;
  CGRAData_32_1 Fu2__recv_in__msg [0:1] ;
  logic [0:0] Fu2__recv_in__rdy [0:1] ;
  logic [0:0] Fu2__recv_opt__en ;
  CGRAConfig_5_6_8 Fu2__recv_opt__msg ;
  logic [0:0] Fu2__recv_opt__rdy ;
  logic [0:0] Fu2__send_out__en [0:0] ;
  CGRAData_32_1 Fu2__send_out__msg [0:0] ;
  logic [0:0] Fu2__send_out__rdy [0:0] ;
  logic [0:0] Fu2__to_mem_raddr__en ;
  logic [2:0] Fu2__to_mem_raddr__msg ;
  logic [0:0] Fu2__to_mem_raddr__rdy ;
  logic [0:0] Fu2__to_mem_waddr__en ;
  logic [2:0] Fu2__to_mem_waddr__msg ;
  logic [0:0] Fu2__to_mem_waddr__rdy ;
  logic [0:0] Fu2__to_mem_wdata__en ;
  CGRAData_32_1 Fu2__to_mem_wdata__msg ;
  logic [0:0] Fu2__to_mem_wdata__rdy ;

  Shifter__e40fd35acc74a5b8 Fu2
  (
    .clk( Fu2__clk ),
    .reset( Fu2__reset ),
    .from_mem_rdata__en( Fu2__from_mem_rdata__en ),
    .from_mem_rdata__msg( Fu2__from_mem_rdata__msg ),
    .from_mem_rdata__rdy( Fu2__from_mem_rdata__rdy ),
    .recv_const__en( Fu2__recv_const__en ),
    .recv_const__msg( Fu2__recv_const__msg ),
    .recv_const__rdy( Fu2__recv_const__rdy ),
    .recv_in__en( Fu2__recv_in__en ),
    .recv_in__msg( Fu2__recv_in__msg ),
    .recv_in__rdy( Fu2__recv_in__rdy ),
    .recv_opt__en( Fu2__recv_opt__en ),
    .recv_opt__msg( Fu2__recv_opt__msg ),
    .recv_opt__rdy( Fu2__recv_opt__rdy ),
    .send_out__en( Fu2__send_out__en ),
    .send_out__msg( Fu2__send_out__msg ),
    .send_out__rdy( Fu2__send_out__rdy ),
    .to_mem_raddr__en( Fu2__to_mem_raddr__en ),
    .to_mem_raddr__msg( Fu2__to_mem_raddr__msg ),
    .to_mem_raddr__rdy( Fu2__to_mem_raddr__rdy ),
    .to_mem_waddr__en( Fu2__to_mem_waddr__en ),
    .to_mem_waddr__msg( Fu2__to_mem_waddr__msg ),
    .to_mem_waddr__rdy( Fu2__to_mem_waddr__rdy ),
    .to_mem_wdata__en( Fu2__to_mem_wdata__en ),
  ...
  // PyMTL Update Block Source
  // At /home/ct535/project/PyCGRA/fu/basic/ThreeCombo.py:70
  // @s.update
  // def update_mem():
  //   s.to_mem_waddr.en    = b1( 0 )
  //   s.to_mem_wdata.en    = b1( 0 )
  ...
  // PyMTL Update Block Source
  // At /home/ct535/project/PyCGRA/fu/triple/ThreeMulAluShifter.py:28
  // @s.update
  // def update_opt():
  ...
  always_comb begin : update_opt
    send_out__en[0] = recv_in__en[0] && recv_in__en[1] && recv_in__en[2] && recv_in__en[3] && recv_opt__en;
    send_out__en[1] = recv_in__en[0] && recv_in__en[1] && recv_in__en[2] && recv_in__en[3] && recv_opt__en;
    if ( recv_opt__msg.ctrl == __const__OPT_MUL_ADD_LLS ) begin
      Fu0__recv_opt__msg.ctrl = __const__OPT_MUL;
      Fu1__recv_opt__msg.ctrl = __const__OPT_ADD;
      Fu2__recv_opt__msg.ctrl = __const__OPT_LLS;
    end
    else if ( recv_opt__msg.ctrl == __const__OPT_MUL_SUB_LLS ) begin
      Fu0__recv_opt__msg.ctrl = __const__OPT_MUL;
      Fu1__recv_opt__msg.ctrl = __const__OPT_SUB;
      Fu2__recv_opt__msg.ctrl = __const__OPT_LLS;
    end
    else if ( recv_opt__msg.ctrl == __const__OPT_MUL_SUB_LRS ) begin
      Fu0__recv_opt__msg.ctrl = __const__OPT_MUL;
      Fu1__recv_opt__msg.ctrl = __const__OPT_SUB;
      Fu2__recv_opt__msg.ctrl = __const__OPT_LRS;
    end
    else
      for ( int j = 0; j < __const__num_outports_at_update_opt; j += 1 )
        send_out__en[j] = 1'd0;
  end

  // PyMTL Update Block Source
  // At /home/ct535/project/PyCGRA/fu/basic/ThreeCombo.py:53
  // @s.update
  // def update_signal():
  ...
  always_comb begin : update_signal
    ...
    recv_in__rdy[3] = send_out__rdy[0];
    Fu0__recv_opt__en = recv_opt__en;
    Fu1__recv_opt__en = recv_opt__en;
    Fu2__recv_opt__en = recv_opt__en;
  ...
  assign Fu1__recv_in__msg[0] = recv_in__msg[2];
  assign Fu1__recv_in__msg[1] = recv_in__msg[3];
  assign Fu2__recv_in__msg[0] = Fu0__send_out__msg[0];
  assign Fu2__recv_in__msg[1] = Fu1__send_out__msg[0];
  assign send_out__msg[0] = Fu2__send_out__msg[0];
  assign send_out__msg[1] = Fu2__send_out__msg[0];

endmodule


// PyMTL Component FlexibleFu Definition
// Full name: FlexibleFu__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_8__num_inports_4__num_outports_2__data_mem_size_8__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>, <class 'PyCGRA.fu.single.Mul.Mul'>, <class 'PyCGRA.fu.single.Logic.Logic'>, <class 'PyCGRA.fu.single.Shifter.Shifter'>, <class 'PyCGRA.fu.single.Phi.Phi'>, <class 'PyCGRA.fu.single.Comp.Comp'>, <class 'PyCGRA.fu.single.Branch.Branch'>, <class 'PyCGRA.fu.single.MemUnit.MemUnit'>, <class 'PyCGRA.fu.triple.ThreeMulAluShifter.ThreeMulAluShifter'>]
// At /home/ct535/project/PyCGRA/fu/flexible/FlexibleFu.py

module FlexibleFu__5b91cad2db8d5f04
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en [0:8],
  input CGRAData_32_1 from_mem_rdata__msg [0:8],
  ...
  output CGRAData_32_1 send_out__msg [0:1],
  input logic [0:0] send_out__rdy [0:1],
  output logic [0:0] to_mem_raddr__en [0:8],
  output logic [2:0] to_mem_raddr__msg [0:8],
  input logic [0:0] to_mem_raddr__rdy [0:8],
  output logic [0:0] to_mem_waddr__en [0:8],
  output logic [2:0] to_mem_waddr__msg [0:8],
  input logic [0:0] to_mem_waddr__rdy [0:8],
  output logic [0:0] to_mem_wdata__en [0:8],
  output CGRAData_32_1 to_mem_wdata__msg [0:8],
  input logic [0:0] to_mem_wdata__rdy [0:8]
);
  localparam logic [31:0] fu_list_size = 32'd9;
  localparam logic [31:0] __const__num_outports_at_comb_logic = 32'd2;
  localparam logic [31:0] __const__num_inports_at_comb_logic = 32'd4;
  //-------------------------------------------------------------
  // Component fu[0:8]
  ...
  logic [0:0] fu__from_mem_rdata__en [0:8] ;
  CGRAData_32_1 fu__from_mem_rdata__msg [0:8] ;
  logic [0:0] fu__from_mem_rdata__rdy [0:8] ;
  logic [0:0] fu__recv_const__en [0:8] ;
  CGRAData_32_1 fu__recv_const__msg [0:8] ;
  logic [0:0] fu__recv_const__rdy [0:8] ;
  logic [0:0] fu__recv_in__en [0:8][0:3] ;
  CGRAData_32_1 fu__recv_in__msg [0:8][0:3] ;
  logic [0:0] fu__recv_in__rdy [0:8][0:3] ;
  logic [0:0] fu__recv_opt__en [0:8] ;
  CGRAConfig_5_6_8 fu__recv_opt__msg [0:8] ;
  logic [0:0] fu__recv_opt__rdy [0:8] ;
  logic [0:0] fu__send_out__en [0:8][0:1] ;
  CGRAData_32_1 fu__send_out__msg [0:8][0:1] ;
  logic [0:0] fu__send_out__rdy [0:8][0:1] ;
  logic [0:0] fu__to_mem_raddr__en [0:8] ;
  logic [2:0] fu__to_mem_raddr__msg [0:8] ;
  logic [0:0] fu__to_mem_raddr__rdy [0:8] ;
  logic [0:0] fu__to_mem_waddr__en [0:8] ;
  logic [2:0] fu__to_mem_waddr__msg [0:8] ;
  logic [0:0] fu__to_mem_waddr__rdy [0:8] ;
  logic [0:0] fu__to_mem_wdata__en [0:8] ;
  CGRAData_32_1 fu__to_mem_wdata__msg [0:8] ;
  ...
  Shifter__69fcd339a65ec916 fu__3
  (
    .clk( fu__clk[3] ),
    .reset( fu__reset[3] ),
  ...
  Branch__69fcd339a65ec916 fu__6
  (
    .clk( fu__clk[6] ),
    .reset( fu__reset[6] ),
  ...
  MemUnit__d7737d485a172c54 fu__7
  (
    .clk( fu__clk[7] ),
    .reset( fu__reset[7] ),
  ...
  ThreeMulAluShifter__d7737d485a172c54 fu__8
  (
    .clk( fu__clk[8] ),
    .reset( fu__reset[8] ),
...
// Full name: Tile__DataType_CGRAData_32_1__CtrlType_CGRAConfig_5_6_8__ctrl_mem_size_3__data_mem_size_8__num_ctrl_3__num_fu_inports_4__num_fu_outports_2__num_connect_inports_4__num_connect_outports_4__Fu_FlexibleFu__FuList_[<class 'PyCGRA.fu.single.Alu.Alu'>, <class 'PyCGRA.fu.single.Mul.Mul'>, <class 'PyCGRA.fu.single.Logic.Logic'>, <class 'PyCGRA.fu.single.Shifter.Shifter'>, <class 'PyCGRA.fu.single.Phi.Phi'>, <class 'PyCGRA.fu.single.Comp.Comp'>, <class 'PyCGRA.fu.single.Branch.Branch'>, <class 'PyCGRA.fu.single.MemUnit.MemUnit'>, <class 'PyCGRA.fu.triple.ThreeMulAluShifter.ThreeMulAluShifter'>]
// At /home/ct535/project/PyCGRA/tile/Tile.py

module Tile__3413444feb47dee0
(
  input logic [0:0] clk,
  input logic [0:0] reset,
  input logic [0:0] from_mem_rdata__en,
  ...
  logic [0:0] element__from_mem_rdata__en [0:8] ;
  CGRAData_32_1 element__from_mem_rdata__msg [0:8] ;
  ...
  logic [0:0] element__to_mem_raddr__en [0:8] ;
  logic [2:0] element__to_mem_raddr__msg [0:8] ;
  logic [0:0] element__to_mem_raddr__rdy [0:8] ;
  logic [0:0] element__to_mem_waddr__en [0:8] ;
  logic [2:0] element__to_mem_waddr__msg [0:8] ;
  logic [0:0] element__to_mem_waddr__rdy [0:8] ;
  logic [0:0] element__to_mem_wdata__en [0:8] ;
  CGRAData_32_1 element__to_mem_wdata__msg [0:8] ;
  logic [0:0] element__to_mem_wdata__rdy [0:8] ;

  FlexibleFu__5b91cad2db8d5f04 element
  (
    .clk( element__clk ),
  ...
  assign element__from_mem_rdata__msg[1] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[2] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[3] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[4] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[5] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[6] = { 32'd0, 1'd0 };
  ...
  assign element__from_mem_rdata__msg[8] = { 32'd0, 1'd0 };
